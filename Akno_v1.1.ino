...
void info(){
  ...
  u8g2.drawStr(3, 36, "By Abdulsalam Abbod");
  u8g2.drawStr(3, 46, "Vist my github page");
  u8g2.sendBuffer();
    break;
        
        case 1: 
 u8g2.drawStr(3, 26,"for checking updates at");      
  u8g2.drawStr(3, 36, "github/AknoBot");
  u8g2.drawStr(3, 47, "Thnx for your Support");
  u8g2.sendBuffer();        
            break; 
       }    
